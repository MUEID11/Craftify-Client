    ...
    <section className="dark:bg-gray-100 dark:text-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-1 flex justify-center">
          <Lottie className="w-52" animationData={faq}></Lottie>
        </div>
          ...
          <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 dark:divide-gray-300">
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  Beginner-friendly craft projects include simple activities
                  like paper crafting (origami, card-making), painting (acrylic
                  or watercolor), knitting or crocheting, and DIY home decor
                  projects (candle-making, terrariums).
                </p>
              </div>
            </details>
            <details>
              ...
              <div className="px-4 pb-4">
                <p>
                  Improving crafting skills involves practicing regularly,
                  seeking inspiration from various sources (books, online
                  tutorials, workshops), experimenting with new techniques and
                  materials, and joining crafting communities or clubs to learn
                  from others.
                </p>
              </div>
            </details>
            <details>
              ...
              <div className="px-4 pb-4 space-y-2">
                <p>
                  ...
                  wood. Practices such as reducing waste, upcycling old items,
                  and using non-toxic adhesives and paints also contribute to
            ...
            <details>
              ...
              <div className="px-4 pb-4 space-y-2">
                <p>
                  Pricing handmade crafts involves considering factors such as
                  the cost of materials, labor (time spent crafting), overhead
            ...
            <details>
              ...
              <div className="px-4 pb-4 space-y-2">
                <p>
                  ...
                  freelance crafting services (e.g., custom orders, event
                  decor).
                </p>
              </div>
            </details>
